...
static void ShowWindowsDirectoryInfo()
{
    ...
    DirectoryInfo dir = new DirectoryInfo($@"D{Path.VolumeSeparatorChar}{Path.DirectorySeparatorChar}UNIVER{dirSep}#{dirSep}Pro C# 9.0{dirSep}CH 20{dirSep}Chapter20_AllProject");
...
static void DisplayImageFiles()
{
    ...
    DirectoryInfo(@"D:\MUSOR\2ch_ImageParser\PARSED\264329898\img");
